...
@section('title', 'Receptionniste Dashboard')

@section('sidebar')
    <a href="{{ route('receptionist.dashboard') }}" class="block px-4 py-3 rounded hover:bg-white/10 transition bg-white/10"><i class="fas fa-tachometer-alt me-3"></i><span>Dashboard</span></a>
...
@section('content')
<div class="mb-8">
    <h2 class="text-4xl font-bold text-white mb-2">Dashboard Receptionniste</h2>
...
<div class="card p-6">
    <div class="flex justify-between items-center mb-6">
        <h3 class="text-2xl font-bold flex items-center">
            <span class="mr-2"></span> Membres Recents
        </h3>
    ...
    @if($recentMembers->isEmpty())
        <div class="text-center py-12">
            ...
            <p class="text-gray-500 text-lg">Aucun membre recent</p>
